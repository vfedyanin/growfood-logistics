...
const LOC = {
  ...
  // Погрузка Поляны — «ул. Красная Сосна, д. 30, с. 1» (подтверждено владельцем 30.07.2026).
  // Адрес LOC-POLYANA в справочнике исправлен на Красную Сосну (был Докукина 10с11).
